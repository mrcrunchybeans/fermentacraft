...
import '../utils/utils.dart'; // Assuming CiderUtils is here
...
class _SulfiteToolTabState extends State<So2CalculatorPage> {
  ...
  void initState() {
    ...
    _updateCalculations(); // Initial calculation
  }

  /// Central method to calculate all results based on current state.
  void _updateCalculations() {
    ...
    switch (selectedSource) {
      ...
      case '5% Stock Solution':
        ...
        calculatedSourceNote = "Mix 10g K-Meta with 100mL water (SG ~1.0275). 1mL per liter yields 50 ppm.";
        break;
    }
          ...
          SwitchListTile(
            ...
            onChanged: (val) {
              setState(() {
                ...
                if (!val) {
                  // Pre-populate custom PPM with the current recommendation
